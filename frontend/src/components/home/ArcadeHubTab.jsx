        ...
        <div className="max-w-4xl mx-auto w-full px-4 py-8 font-sans relative">
            ...
            <div className="text-center mb-10 relative z-10">
                <div className="inline-flex p-3 bg-violet-600/10 border-2 border-violet-500/20 rounded-2xl mb-4 animate-pulse">
                    <Trophy className="text-violet-400" size={32} />
                </div>
                <h1 className="font-mouse-memoirs text-5xl md:text-6xl leading-none uppercase tracking-wider text-white">
                    L'Arcade Musicale
                </h1>
                <p className="text-zinc-400 mt-2 text-sm md:text-base font-medium tracking-wide max-w-md mx-auto">
                    Défiez vos connaissances musicales et prouvez votre dévouement à votre artiste favori.
                </p>

                {user?.favArtistName && (
                    <div className="inline-flex items-center gap-3 bg-black/30 border border-white/5 px-4 py-2 rounded-full mt-5">
                        {user.favArtistImage ? (
                            <img src={user.favArtistImage} alt={user.favArtistName} className="w-6 h-6 rounded-full object-cover border border-white/10" />
                        ) : (
                            <Music size={12} className="text-violet-400" />
                        )}
                        <span className="text-xs font-semibold text-zinc-300">
                            Artiste cible : <span className="text-violet-400 font-extrabold uppercase">{user.favArtistName}</span>
                        </span>
                    </div>
                )}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10 mt-4">
                ...
                >
                    ...
                    <div>
                        ...
                        <h2 className="font-mouse-memoirs text-3xl md:text-4xl text-white uppercase tracking-wider mb-2.5">
                    ...
                    <div className="mt-8 flex items-center justify-between">
                        <div className="flex gap-2">
                            <span className="text-[10px] font-black uppercase tracking-wider bg-violet-950 text-violet-300 border border-violet-500/30 px-2 py-0.5 rounded-md">
                                Audio 🔊
                            </span>
                            <span className="text-[10px] font-black uppercase tracking-wider bg-zinc-800 text-zinc-400 border border-zinc-700 px-2 py-0.5 rounded-md">
                                10 Qs ⏱️
                            </span>
                        </div>
                ...
                >
                    ...
                    <div className="mt-8 flex items-center justify-between">
                        <div className="flex gap-2">
                            <span className="text-[10px] font-black uppercase tracking-wider bg-fuchsia-950 text-fuchsia-300 border border-fuchsia-500/30 px-2 py-0.5 rounded-md">
                                Visuel 🎨
                            </span>
                            <span className="text-[10px] font-black uppercase tracking-wider bg-zinc-800 text-zinc-400 border border-zinc-700 px-2 py-0.5 rounded-md">
                                Flou 🌀
            ...
            {/* Profile Warning */}
            {!user?.favArtistName && (
                <div className="mt-8 neobrutal-card border-amber-500 bg-amber-500/10 text-amber-200 p-5 rounded-2xl flex items-start gap-4 z-10 max-w-xl mx-auto">
                    ...
                    <div className="space-y-1">
                        ...
                        <button
                            ...
                            className="mt-2 text-xs font-black text-amber-400 hover:text-amber-300 underline uppercase tracking-widest cursor-pointer"
                        >
