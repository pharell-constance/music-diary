...
export default function BlindTestTab({ user, onBackToHome }) {
    ...
    return (
        <div ref={gameContainerRef} className="max-w-4xl mx-auto w-full px-4 py-6 font-sans relative">
            ...
            {gameState === 'LOADING' && (
                <div className="neobrutal-card bg-zinc-900 border-4 border-black p-6 sm:p-12 rounded-3xl shadow-[8px_8px_0px_#000000] flex flex-col items-center justify-center text-center gap-6 game-card-anim">
