...
function LandingPage() {
    ...
    return (
        <div className="h-screen overflow-y-auto bg-[#07050f] text-white font-sans overflow-x-hidden relative flex flex-col justify-between">
            {/* Background glowing blobs */}
            <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-violet-600/10 rounded-full blur-[130px] pointer-events-none"></div>
            <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-fuchsia-600/10 rounded-full blur-[130px] pointer-events-none"></div>
            <div className="absolute top-[40%] right-[10%] w-[30%] h-[30%] bg-pink-600/5 rounded-full blur-[150px] pointer-events-none"></div>

            {/* Header */}
            <header className="w-full max-w-7xl mx-auto px-6 py-5 flex items-center justify-between border-b border-white/[0.06] backdrop-blur-md sticky top-0 z-50">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button 
                        ...
                        className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-violet-500 to-fuchsia-600 hover:from-violet-400 hover:to-fuchsia-500 text-white text-sm font-extrabold shadow-[0_0_15px_rgba(139,92,246,0.3)] hover:shadow-[0_0_20px_rgba(139,92,246,0.45)] hover:scale-[1.02] transition-all duration-300 cursor-pointer"
                    >
                        Créer un compte
                    </button>
                </div>
            ...
            <main className="flex-1 max-w-7xl mx-auto px-6 py-12 md:py-20 space-y-24 md:space-y-32">
                ...
                <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
                        ...
                        <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight leading-[1.1] text-white">
                            Le journal de bord de votre <span className="bg-gradient-to-r from-violet-400 via-fuchsia-400 to-pink-500 bg-clip-text text-transparent">voyage musical</span>.
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
                            <button
                                onClick={() => navigate('/register')}
                                className="w-full sm:w-auto px-8 py-4 rounded-xl bg-gradient-to-r from-violet-500 to-fuchsia-600 hover:from-violet-400 hover:to-fuchsia-500 text-white font-black flex items-center justify-center gap-2 shadow-[0_0_25px_rgba(139,92,246,0.3)] hover:shadow-[0_0_30px_rgba(139,92,246,0.5)] hover:scale-[1.03] transition-all duration-300 cursor-pointer text-sm"
                            >
                                Commencer l'expérience <ArrowRight size={16} />
                            </button>
                            <button
                                onClick={() => navigate('/login')}
                                className="w-full sm:w-auto px-8 py-4 rounded-xl border border-white/[0.08] hover:border-white/20 bg-white/[0.02] hover:bg-white/[0.05] text-white font-bold transition-all duration-300 cursor-pointer text-sm"
                            >
                                Découvrir le site
                            </button>
                        </div>
                    ...
                    <div className="lg:col-span-5 relative h-[400px] flex items-center justify-center">
                        {/* Blob backdrop */}
                        <div className="absolute w-72 h-72 bg-violet-500/10 rounded-full blur-[80px] pointer-events-none"></div>

                        {/* Card 1: Review Card Mockup */}
                        <div className="absolute top-6 left-4 md:left-10 w-[280px] sm:w-[320px] bg-white/[0.03] border border-white/[0.08] p-5 rounded-2xl shadow-2xl backdrop-blur-md transform -rotate-3 hover:-rotate-1 transition-all duration-500 group cursor-default">
                        ...
                        <div className="absolute bottom-6 right-4 md:right-10 w-[240px] bg-gradient-to-tr from-violet-600/90 to-fuchsia-500/85 p-5 rounded-2xl shadow-2xl shadow-violet-500/20 transform rotate-6 hover:rotate-3 transition-all duration-500 cursor-default text-white">
                ...
                <section className="space-y-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        {/* Feature 1 */}
                        <div className="bg-white/[0.02] backdrop-blur-md border border-white/[0.06] hover:border-violet-500/20 p-6 rounded-2xl transition-all duration-300 group hover:-translate-y-1">
                ...
                <section className="bg-white/[0.02] backdrop-blur-xl border border-white/[0.07] rounded-3xl p-8 md:p-12 flex flex-col md:flex-row md:items-center justify-between gap-8 relative overflow-hidden shadow-2xl">
                    {/* Glowing effect inside */}
                    <div className="absolute top-[-50%] right-[-20%] w-96 h-96 bg-violet-500/10 rounded-full blur-[100px] pointer-events-none"></div>
                    ...
                    <div className="flex-shrink-0 flex flex-col sm:flex-row gap-3 relative z-10">
                        <button
                            onClick={() => navigate('/register')}
                            className="px-6 py-3.5 rounded-xl bg-gradient-to-r from-violet-500 to-fuchsia-600 hover:from-violet-400 hover:to-fuchsia-500 text-white font-extrabold text-sm shadow-[0_0_15px_rgba(139,92,246,0.25)] hover:scale-[1.02] transition-all duration-300 cursor-pointer"
                        >
                            Créer un compte gratuitement
                        </button>
                        <button
                            onClick={() => navigate('/login')}
                            className="px-6 py-3.5 rounded-xl border border-white/[0.08] hover:border-white/20 bg-white/[0.02] text-white font-bold text-sm transition-all duration-200 cursor-pointer"
                        >
                            Se connecter
                        </button>
                    </div>
            ...
            {/* Footer */}
            <footer className="w-full border-t border-white/[0.04] py-8 text-center text-xs text-zinc-600 z-10">
                <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div className="flex items-center gap-2">
                        <div className="w-5 h-5 bg-gradient-to-br from-violet-500 to-fuchsia-600 rounded-md flex items-center justify-center shadow-md">
                            <Disc className="text-white" size={10} />
                        </div>
